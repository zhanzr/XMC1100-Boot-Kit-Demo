...
AFLAGS += -I$(RTE_INC) -I$(XMCLIB_INC) -I$(DEVICE_INC) -I$(CMSIS_CORE_INC)
AFLAGS += -g --apcs=interwork

OPT_LEVEL = 3

CFLAGS = -D$(DERIVATE) -I$(XMCLIB_INC) -I$(DEVICE_INC) -I$(CMSIS_CORE_INC) -I$(RTE_INC) -I$(RTE_DEVICE_INC)
CFLAGS += --c99
