...
GLOBAL_CCU4_t GLOBAL_CCU4_0 = {
    ...
    .mcs_action =
        (XMC_CCU4_SLICE_MCMS_ACTION_t)XMC_CCU4_SLICE_MCMS_ACTION_TRANSFER_PR_CR,
    .is_initialized = false};

static inline void RS_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT0, 0); }

static inline void RS_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT0, 0); }

static inline void RW_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT0, 1); }

static inline void RW_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT0, 1); }

static inline void E_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT0, 2); }

static inline void E_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT0, 2); }

static inline void D4_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT0, 9); }

static inline void D4_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT0, 9); }

static inline void D5_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT1, 1); }

static inline void D5_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT1, 1); }

static inline void D6_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT1, 0); }

static inline void D6_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT1, 0); }

static inline void D7_H(void) { XMC_GPIO_SetOutputHigh(XMC_GPIO_PORT0, 7); }

static inline void D7_L(void) { XMC_GPIO_SetOutputLow(XMC_GPIO_PORT0, 7); }
...
PWM_CCU4_STATUS_t PWM_CCU4_Init(PWM_CCU4_t *handle_ptr) {
  ...
  if (PWM_CCU4_STATE_UNINITIALIZED == handle_ptr->state) {
    ...
    status_ccu4_global =
        GLOBAL_CCU4_Init(handle_ptr->config_ptr->global_ccu4_handle);
    ...
    if (GLOBAL_CCU4_STATUS_SUCCESS == status_ccu4_global) {
      ...
      XMC_CCU4_SLICE_SetShadowTransferMode(
          handle_ptr->ccu4_slice_ptr,
          handle_ptr->config_ptr->shadow_transfer_mode);
      XMC_CCU4_SLICE_WriteImmediateAfterShadowTransfer(
          handle_ptr->ccu4_slice_ptr, handle_ptr->config_ptr->immediate_write);
      ...
      XMC_CCU4_EnableShadowTransfer(handle_ptr->ccu4_module_ptr,
                                    handle_ptr->shadow_txfr_msk);
      XMC_CCU4_EnableShadowTransfer(handle_ptr->ccu4_module_ptr,
                                    handle_ptr->dither_shadow_txfr_msk);
      ...
      if ((bool)true == handle_ptr->config_ptr->gpio_ch_out_enable) {
        XMC_GPIO_Init(handle_ptr->config_ptr->gpio_ch_out_ptr,
                      handle_ptr->config_ptr->gpio_ch_out_pin,
                      handle_ptr->config_ptr->gpio_ch_out_config_ptr);
      }

      frequency_module =
          handle_ptr->config_ptr->global_ccu4_handle->module_frequency;
      prescalar = (uint32_t)handle_ptr->config_ptr->ccu4_cc4_slice_timer_ptr
                      ->prescaler_initval;
...
void PWM_CCU4_lInit_Interrupt(PWM_CCU4_t *handle_ptr) {
  ...
  /* Enable events. Bind event to corresponding service request node.Enable
   Interrupts. The user may choose to disable the interrupts by LLD calls. */
  if ((bool)true == handle_ptr->config_ptr->int_per_match) {
    XMC_DEBUG("PWM_CCU4_Init: Interrupt period match enable");
    XMC_CCU4_SLICE_SetInterruptNode(handle_ptr->ccu4_slice_ptr,
                                    XMC_CCU4_SLICE_IRQ_ID_PERIOD_MATCH,
                                    handle_ptr->config_ptr->sr_per_match);
    XMC_CCU4_SLICE_EnableEvent(handle_ptr->ccu4_slice_ptr,
                               XMC_CCU4_SLICE_IRQ_ID_PERIOD_MATCH);
  }
...
void PWM_CCU4_lConfigure_Events(PWM_CCU4_t *handle_ptr) {
  ...
  XMC_CCU4_SLICE_ConfigureEvent(handle_ptr->ccu4_slice_ptr,
  ...
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_start_event) {
    XMC_CCU4_SLICE_StartConfig(handle_ptr->ccu4_slice_ptr,
  ...
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_stop_event) {
    XMC_CCU4_SLICE_StopConfig(handle_ptr->ccu4_slice_ptr,
  ...
  if (XMC_CCU4_SLICE_EVENT_NONE !=
      handle_ptr->config_ptr->ext_count_dir_event) {
    XMC_CCU4_SLICE_DirectionConfig(handle_ptr->ccu4_slice_ptr,
                                   handle_ptr->config_ptr->ext_count_dir_event);
  }
  ...
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_gate_event) {
    XMC_CCU4_SLICE_GateConfig(handle_ptr->ccu4_slice_ptr,
  ...
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_count_event) {
    XMC_CCU4_SLICE_CountConfig(handle_ptr->ccu4_slice_ptr,
                               handle_ptr->config_ptr->ext_count_event);
  }
  /* Timer gets loaded with compare register value or period register value on
   * external signal */
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_load_event) {
    XMC_CCU4_SLICE_LoadConfig(handle_ptr->ccu4_slice_ptr,
                              handle_ptr->config_ptr->ext_load_event);
  }
  /* External signal PWM signal (ST bit) output gets modulated by external
   * signal */
  if (XMC_CCU4_SLICE_EVENT_NONE != handle_ptr->config_ptr->ext_mod_event) {
    XMC_CCU4_SLICE_ModulationConfig(handle_ptr->ccu4_slice_ptr,
                                    handle_ptr->config_ptr->ext_mod_event,
                                    handle_ptr->config_ptr->ext_mod_mode,
  ...
  if (XMC_CCU4_SLICE_EVENT_2 == handle_ptr->config_ptr->ext_trap_event) {
    XMC_CCU4_SLICE_TrapConfig(handle_ptr->ccu4_slice_ptr,
  ...
  if ((XMC_CCU4_SLICE_EVENT_1 ==
       handle_ptr->config_ptr->ext_override_edge_event) &&
      (XMC_CCU4_SLICE_EVENT_2 ==
       handle_ptr->config_ptr->ext_override_level_event)) {
    XMC_CCU4_SLICE_ConfigureStatusBitOverrideEvent(
        handle_ptr->ccu4_slice_ptr, handle_ptr->config_ptr->event1_config_ptr,
        handle_ptr->config_ptr->event2_config_ptr);
    XMC_CCU4_SLICE_StatusBitOverrideConfig(handle_ptr->ccu4_slice_ptr);
  }
}
/**********************************************************************************************************/
/*Starts the CCU4_CC4 slice. This needs to be called even if external start is
 * configured.*/
PWM_CCU4_STATUS_t PWM_CCU4_Start(PWM_CCU4_t *handle_ptr) {
  ...
  if ((PWM_CCU4_STATE_INITIALIZED == handle_ptr->state) ||
...
PWM_CCU4_STATUS_t PWM_CCU4_Stop(PWM_CCU4_t *handle_ptr) {
  ...
  if (PWM_CCU4_STATE_UNINITIALIZED != handle_ptr->state) {
    ...
    XMC_CCU4_DisableClock(handle_ptr->ccu4_module_ptr,
...
uint32_t PWM_CCU4_GetTimerValue(PWM_CCU4_t *handle_ptr) {
  ...
  timer_value =
      (uint32_t)XMC_CCU4_SLICE_GetTimerValue(handle_ptr->ccu4_slice_ptr);
...
PWM_CCU4_STATUS_t PWM_CCU4_SetFreq(PWM_CCU4_t *handle_ptr,
  ...
  if (PWM_CCU4_STATE_UNINITIALIZED != handle_ptr->state) {
    if (0U == pwm_freq_hz) {
      ...
      if ((uint32_t)XMC_CCU4_SLICE_TIMER_COUNT_MODE_CA ==
...
PWM_CCU4_STATUS_t PWM_CCU4_SetDutyCycle(PWM_CCU4_t *handle_ptr,
                                        uint32_t duty_cycle) {
  PWM_CCU4_STATUS_t status;
  uint32_t period;
  uint32_t compare;
  ...
  if (PWM_CCU4_STATE_UNINITIALIZED != handle_ptr->state) {
    ...
    if ((duty_cycle > PWM_CCU4_SYM_DUTY_MAX)) {
      ...
      period = (uint32_t)XMC_CCU4_SLICE_GetTimerPeriodMatch(
                   handle_ptr->ccu4_slice_ptr) +
               1U;

      /* Duty Cycle(symmetric) = (PR-CR1)+1 / period */
      compare = ((period * (PWM_CCU4_DUTY_FULL_SCALE - duty_cycle)) /
...
PWM_CCU4_STATUS_t PWM_CCU4_SetFreqAndDutyCycle(PWM_CCU4_t *handle_ptr,
                                               uint32_t pwm_freq_hz,
                                               uint32_t duty) {
  ...
  status = PWM_CCU4_STATUS_FAILURE;
  frequency_tclk = 0U;
  XMC_ASSERT("PWM_CCU4_SetFreqAndDutyCycle:handle_ptr NULL",
             (handle_ptr != NULL));
  if (PWM_CCU4_STATE_UNINITIALIZED != handle_ptr->state) {
    if (0U == pwm_freq_hz) {
      XMC_DEBUG(
          "PWM_CCU4_SetFreqAndDutyCycleSymmetric:cannot set frequency 0Hz");
      ...
      if ((period != 0U) && (period <= PWM_CCU4_MAX_TIMER_COUNT)) {
        /*Calculate the current duty cycle in no-timer concatenation mode*/
        compare = ((period * (PWM_CCU4_DUTY_FULL_SCALE - duty)) /
                   PWM_CCU4_DUTY_FULL_SCALE);
...
void PWM_CCU4_SetDither(PWM_CCU4_t *handle_ptr, bool dither_period,
                        bool dither_comp, uint8_t dither_value) {

  XMC_ASSERT("PWM_CCU4_SetDither:handle_ptr NULL", (handle_ptr != NULL));
  XMC_CCU4_SLICE_EnableDithering(handle_ptr->ccu4_slice_ptr, dither_period,
                                 dither_comp, dither_value);
  XMC_CCU4_EnableShadowTransfer(handle_ptr->ccu4_module_ptr,
                                handle_ptr->dither_shadow_txfr_msk);
...
void PWM_CCU4_ClearTrap(PWM_CCU4_t *handle_ptr) {
  ...
  XMC_CCU4_SLICE_ClearEvent(handle_ptr->ccu4_slice_ptr,
                            XMC_CCU4_SLICE_IRQ_ID_EVENT2);
...
bool PWM_CCU4_GetInterruptStatus(PWM_CCU4_t *handle_ptr,
                                 XMC_CCU4_SLICE_IRQ_ID_t pwm_interrupt) {
  bool status = (bool)false;
  XMC_ASSERT("PWM_CCU4_GetInterruptStatus:handle_ptr NULL",
             (handle_ptr != NULL));
...
void PWM_CCU4_ClearEvent(PWM_CCU4_t *handle_ptr,
                         XMC_CCU4_SLICE_IRQ_ID_t pwm_interrupt) {
